...
class realNoisy(Dataset):
    def __init__(self, args):
        ...
        elif args.dataset == 'SDAP_SIDD':
           args.folder_path = '/shenlab/lab_stor/yilinliu/SDAP/dataset/sidd_val_img/SIDD_noisy'
           gt_path ='/shenlab/lab_stor/yilinliu/SDAP/dataset/sidd_val_img/SIDD_clean'
        else:
...
class SDAP_SIDD(Dataset):
    def __init__(self, args):
        "get the test images from: https://github.com/p1y2z3/SDAP/tree/main/dataset"

        if args.dataset == 'SDAP_SIDD':
           args.folder_path = '/shenlab/lab_stor/yilinliu/SDAP/dataset/sidd_val_img/SIDD_noisy'
           gt_path ='/shenlab/lab_stor/yilinliu/SDAP/dataset/sidd_val_img/SIDD_clean'
        else:
           raise ValueError('dataset %s not included yet' % args.dataset)
...
class SIDD(Dataset):
    def __init__(self, args):
        ...
        if args.dataset == 'SIDD':
           args.folder_path = '/home/yilinliu/stor/dataset/SIDD-small'
        else:
           raise ValueError('dataset %s not included yet' % args.dataset)
...
#                   img_noisy_pil = crop_image(get_image(noisy_fname, imsize)[0], d=32)
                   ...
                   print(f"after cropping: {img_noisy_np.shape}")
                   fname = f"{ID}_noisy"
